...
public class EnchantmentData {
    ...
    public static class EnchantmentDetails {
        ...
        public EnchantmentDetails(int[] ranges, int weight, int anvilCostMultiplier, boolean obtainableFromEnchantingTable) {
            this.ranges = ranges;
            this.weight = weight;
